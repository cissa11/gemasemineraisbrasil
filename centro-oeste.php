        ...
        <div class="container">
            ...
            <body>
                ...
                <div style = "float:left;" id = "inicio">
                    <h1>Você selecionou a região<br>Centro-Oeste!</h1>
                </div>

                <div id = "imagem">
                    <img class="irc_mi" src="https://www.infoescola.com/wp-content/uploads/2008/10/regiao-centro-oeste-450x450.jpg"  width="464" height="464" >
                </div>
                ...
                <div id = "menu">
                    ...
                    <a href="asbesto.php" style = "color: #088A29" >1ª Asbesto</a><br><br>	
                    <a href="cobre.php" style = "color: #088A29">2ª Cobre</a><br><br>
                    <a href="niquel.php" style = "color: #088A29">3ª Níquel</a><br><br>
                ...
                <div id = "menu2">
                    ...
                    <a href="cristal.php" style = "color: #088A29">1ª Cristal</a><br><br>	
                    <a href="crisoberilo.php" style = "color: #088A29">2ª Crisoberilo</a><br><br>
