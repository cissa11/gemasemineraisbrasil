        ...
        <div class="container">
            ...
            <body>
                ...
                <div style = "float:left;" id = "inicio">
                    <h1>Você selecionou a região Norte!</h1>
                </div>
<br><br>
                <div id = "imagem">
                    <img class="irc_mi" src="https://www.infoescola.com/wp-content/uploads/2008/10/regiao-norte-450x450.jpg"  width="464" height="464" >
                </div>
                ...
                <div id = "menu">
                    ...
                    <a href="bauxita.php" style = "color: #088A29" >1ª Bauxita</a><br><br>	
                    <a href="estanho.php" style = "color: #088A29">2ª Estanho</a><br><br>
                    <a href="manganes.php" style = "color: #088A29">3ª Manganês</a><br><br>
                ...
                <div id = "menu2">
                    ...
                    <a href="jade.php" style = "color: #088A29">1ª Jade</a><br><br>	
                    <a href="rubi.php" style = "color: #088A29">2ª Rubi</a><br><br>
                    <a href="turquesa.php" style = "color: #088A29">3ª Turquesa</a><br><br>
