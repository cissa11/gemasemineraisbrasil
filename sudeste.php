...
<body>
		...
		<h1>Você selecionou a região Sudeste!</h1>
		</div>
	
		<div id = "imagem">
			<img class="irc_mi" src="https://www.infoescola.com/wp-content/uploads/2008/10/regiao-sudeste-768x768.jpg"  width="464" height="464" >
		</div>
		...
		<div id = "menu">
				...
				<a href="barita.php" style = "color: #088A29" >1ª Barita</a><br><br>		
                <a href="cassiterita.php" style = "color: #088A29">2ª Cassiterita</a><br><br>
                <a href="granito.php" style = "color: #088A29">3ª Granito</a><br><br>
				<a href="quartzo.php" style = "color: #088A29">4ª Quartzo</a><br><br>
		...
		<h2>Pedras Preciosas</h2>
				...
				<a href="alexandrita.php" style = "color: #088A29">1ª Alexandrita</a><br><br>		
                <a href="diamante.php" style = "color: #088A29">2ª Diamante</a><br><br>
                <a href="esmeralda.php" style = "color: #088A29">3ª Esmeralda</a><br><br>
				<a href="topazio.php" style = "color: #088A29">4ª Topázio</a><br><br>
