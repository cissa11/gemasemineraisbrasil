...
<nav class="navbar navbar-default navbar-fixed-top">
            ...
            <body>
                ...
                <div style = "float:left;" id = "inicio">
                    <h1>Você selecionou a região Nordeste!</h1>
                </div>

                <div id = "imagem">
                    <img class="irc_mi" src="https://www.infoescola.com/wp-content/uploads/2008/10/regiao-nordeste-768x768.jpg"  width="464" height="464" >
                </div>
                ...
                <div id = "menu">
                    ...
                    <a href="gipsita.php" style = "color: #088A29" >1ª Gipsita</a><br><br>	
                    <a href="grafite.php" style = "color: #088A29">2ª Grafite</a><br><br>
                ...
                <div id = "menu2">
                    ...
                    <a href="agua-marinha.php" style = "color: #088A29">1ª Água-Marinha</a><br><br>	
                    <a href="opala.php" style = "color: #088A29">2ª Opala</a><br><br>
                    <a href="turmalina.php" style = "color: #088A29">3ª Turmalina Paraíba</a><br><br>
